 ...
 */
  static load(cat_map_buffer: IBuffer, compat_cat_map_buffer: IBuffer, invoke_def_buffer: IBuffer | undefined) {
 ...
 */
  initCategoryMappings(category_mapping: string | any[] | null) {
