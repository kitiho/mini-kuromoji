...
class TokenInfoDictionary {
  ...
  buildDictionary(entries: string | any[]) {
    const dictionary_entries: any = {} // using as hashmap, string -> string (word_id -> surface_form) to build dictionary
  ...
  put(left_id: any, right_id: any, word_cost: any, surface_form: any, feature: any) {
  ...
  addMapping(source: number, target: string | number) {
  ...
  // from tid.dat
  loadDictionary(array_buffer: IBuffer | undefined) {
    this.dictionary = new ByteBuffer(array_buffer)
    return this
  }

  // from tid_pos.dat
  loadPosVector(array_buffer: IBuffer | undefined) {
    this.pos_buffer = new ByteBuffer(array_buffer)
    return this
  }

  // from tid_map.dat
  loadTargetMap(array_buffer: IBuffer | undefined) {
