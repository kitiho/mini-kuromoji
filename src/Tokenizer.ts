...
class Tokenizer {
  ...
  constructor(dic: { token_info_dictionary: any; unknown_dictionary: any; connection_costs?: any; trie?: any }) {
    this.token_info_dictionary = dic.token_info_dictionary
    this.unknown_dictionary = dic.unknown_dictionary
    this.viterbi_builder = new ViterbiBuilder(dic as any)
 ...
 */
  static splitByPunctuation(input: any) {
    const sentences = []
    let tail = input
    while (true) {
      if (tail === '')
 ...
 */
  ...
  tokenizeForSentence(sentence: any, tokens: any[] | null) {
    if (tokens == null)
      tokens = []
